...
- Chat messages also appear above the sender's player sprite.
- Works for your own player and remote players.
- Bubbles stay visible for about 4.5 seconds.
- Long messages wrap to up to 3 lines.
- The normal chat log still remains in the bottom-left.
